...
Use this file as the human-readable status board. Keep `directory-tracker.csv` as the structured source for sorting/export.

## Submitted / Publication Result
...
| VC.ru | RU business media | yes, 2026-07-19 | 2026-07-19 | https://vc.ru/id5698454/3035242-kak-malomu-biznesu-sozdat-reels-shorts-i-tiktok-bez-semki | Published. The useful article is public, has no draft marker, and contains a clickable calculator link through the standard VC.ru redirect. Topic remains unassigned because the VC.ru editor selector does not apply the selected Marketing topic. |
...
| --- | --- | --- | --- | --- |
| VC.ru | RU business media | https://adshortsai.com/kalkulyator-stoimosti-shorts/ | Published 2026-07-19 with a clickable calculator link. | Manually assign the Marketing topic, then track referral traffic and indexing; do not repeat the same link unnaturally. |
...
| Platform | Status | Reason | Next action |
| --- | --- | --- | --- |
| Нейрокаталог | blocked | Add-service form/link not found; `/add-listing/` returns 404. | Search owner contact later. |
| Neuro-x | blocked | No obvious add-service form found. | Contact manually or revisit later. |
| AiLibri | deprioritized | No simple self-serve submission; requires a manual brief/email and the page frames placement as advertising/cooperation. | Revisit later if we decide to do editorial outreach or paid placements. |
| pickTech | deprioritized | Partner page is aimed at IT vendors/integrators, deals, PPC/PPL, and B2B lead generation; weak fit for the current fast/free organic sprint. | Revisit only if we position AdShorts AI as B2B software for SMM/marketing teams. |
| Product Hunt | paused | English/global launch paused while focus is RU organic. | Resume for international push. |
| Uneed | paused | English/global directories paused. | Resume for international push. |
| SaaSHub | paused | English/global directories paused. | Resume for international push. |
| Futurepedia | paused | English/global directories paused. | Resume for international push. |

## Rules

- Do not mark a placement as `submitted` unless the site/email confirms submission or the owner manually confirms it.
