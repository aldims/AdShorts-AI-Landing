...
const escapeHtml = (value) => value
    ...
    .replaceAll('"', "&quot;")
    .replaceAll("'", "&#39;");
export const parseProductFeedbackSubmission = (value, metadata) => {
...
export const appendProductFeedbackSubmission = async (submission) => {
    await mkdir(env.dataDir, { recursive: true });
    await appendFile(join(env.dataDir, PRODUCT_FEEDBACK_FILE_NAME), `${JSON.stringify(submission)}\n`, "utf8");
};
export const notifyProductFeedbackSubmission = async (submission) => {
