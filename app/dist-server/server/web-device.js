...
const adsflowWebSignalStorage = new AsyncLocalStorage();
...
export const resolveAdsflowClientIp = (req) => firstHeaderIp(req.header("cf-connecting-ip")) ||
...
export const resolveAdsflowWebSignalContext = (req) => {
...
export const setAdsflowWebDeviceCookie = (res, context, options) => {
...
export const runWithAdsflowWebSignal = (context, callback) => adsflowWebSignalStorage.run(context, callback);
...
export const addCurrentAdsflowWebDeviceToBody = (body) => {
    const context = getCurrentAdsflowWebSignalContext();
