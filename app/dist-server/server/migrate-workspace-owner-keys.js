...
const main = async () => {
    ...
    console.info(`[workspace-owner-keys] scanned_users=${result.scannedUsers} migrated_history_rows=${result.migratedHistoryOwners} migrated_deleted_rows=${result.migratedDeletedOwners}`);
};
void main()
    .catch((error) => {
