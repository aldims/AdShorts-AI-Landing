...
const landingGuideCards: Record<Locale, Array<{ label: string; title: string; description: string; href: string }>> = {
  ru: [
    ...
    },
    {
      ...
      description: "Проверки видимости, упаковки, первых секунд и повторной публикации.",
      href: "/shorts-ne-nabirayut-prosmotry/",
    },
    {
      label: "УДЕРЖАНИЕ",
      title: "Низкое удержание в YouTube Shorts",
      description: "Как исправить первый кадр, хук, темп, текст и звук в начале ролика.",
      href: "/nizkoe-uderzhanie-v-youtube-shorts/",
    },
  ],
  en: [
    {
    ...
    {
      label: "VISIBILITY",
      title: "Shorts not showing on channel",
      description: "Check visibility, Shorts recognition, cache, restrictions and channel display.",
      href: "/youtube-shorts-not-showing-on-channel/",
    },
    {
      label: "RETENTION",
      title: "Fix low retention in the first seconds",
      description: "Diagnose the first frame, hook, pacing, text and audio before reuploading.",
      href: "/low-retention-on-youtube-shorts/",
    },
  ],
};
