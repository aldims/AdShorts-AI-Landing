...
import {
  ...
  STUDIO_SEGMENT_INFOGRAPHIC_HOLD_SECONDS,
...
} from "../../../shared/studio-infographic-timing";
...
export const WORKSPACE_SEGMENT_INFOGRAPHIC_FADE_SECONDS = STUDIO_SEGMENT_INFOGRAPHIC_FADE_SECONDS;
export const WORKSPACE_SEGMENT_INFOGRAPHIC_HOLD_SECONDS = STUDIO_SEGMENT_INFOGRAPHIC_HOLD_SECONDS;
export const WORKSPACE_SEGMENT_INFOGRAPHIC_PART_REVEAL_SECONDS =
  STUDIO_SEGMENT_INFOGRAPHIC_PART_REVEAL_SECONDS;
export const WORKSPACE_SEGMENT_INFOGRAPHIC_LEGACY_PART_REVEAL_SECONDS =
  STUDIO_SEGMENT_INFOGRAPHIC_LEGACY_PART_REVEAL_SECONDS;
export const WORKSPACE_SEGMENT_INFOGRAPHIC_TIMING_SCALE = STUDIO_SEGMENT_INFOGRAPHIC_TIMING_SCALE;
