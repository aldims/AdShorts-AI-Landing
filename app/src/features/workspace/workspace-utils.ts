...
export const createWorkspaceClientJobId = (options?: { crypto?: Crypto | null }) => {
...
export const shouldDisplayWorkspaceSegmentVoiceCellEdited = (options: {
  ...
  options.isEffectiveVoiceEdited || options.isGeneratedVoiceoverEdited || options.isTextEdited;
...
export const resolveWorkspaceSegmentVoiceTimelineState = (options: {
  ...
  if (options.isVoiceHistoryDisabled) {
    return {
      canBack: false,
      canForward: false,
      hasHistory: false,
