...
const voiceAliases = new Map<string, keyof typeof STUDIO_VOICE_PREVIEW_SAMPLES>([
  ...
  ["vika_grib", "Vika"],
  ["vika_grib_v3", "Vika"],
  ["vika_grib_natural,_clear_and_friendly", "Vika"],
  ...
  ["hale_smooth,_confident_and_persuasive", "Lesha"],
  ...
  ["michael_c._vincent_confident_expressive", "Misha"],
  ["michael_c._vincent_confident,_expressive", "Misha"],
