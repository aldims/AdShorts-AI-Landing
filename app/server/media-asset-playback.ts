...
const inferWorkspaceMediaAssetPlaybackContentType = (value: string | null | undefined, upstreamUrl: URL) => {
...
const inferWorkspaceMediaAssetPlaybackExtension = (contentType: string, upstreamUrl: URL) => {
